...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void OnClick (View v)
	{
		Toast.makeText(getApplicationContext(), "Clicked Button",
	     ...
	     myDb = openOrCreateDatabase("MyWeatherDB.db", Context.MODE_PRIVATE, null);
	     //myDb.execSQL(MySQL);
	...
	FOR NOW STORE URI INSTEAD OF ENTIRE IMAGE
	if (cur.getCount() == 0)
		Toast.makeText(getApplicationContext(), "Cursor count is zero !!!", Toast.LENGTH_SHORT).show();
